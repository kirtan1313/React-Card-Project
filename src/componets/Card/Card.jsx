        ...
        <div className='main'>
                            ...
                            <div className="card">
                                <div className="row ">
                                    <div className="photo col-4 ">
                                        <img src={users.image} alt="imag" />
                                    </div>
                                    <div className="username col-6">
                                        <div >
                                            User Name :-
                                            <span className='line'>{users.username}</span>
                                        </div>
                                        <div className='email p-top-10'>
                                            Email Id :-
                                            <span>{users.email}</span>
                                        </div>
                                    </div>
                                    <div className="user-data col-12">
                                        <div className="full-Name p-top-10">
                                            Full Name :-
                                            <span>{users.firstName}</span>
                                            <span className='ps-5'>{users.lastName}</span>
                                            <span className='ps-5'>{users.maidenName}</span>
                                        </div>
                                        <div className='Phone-Number p-top-10'>
                                            Phone Number :-
                                            <span>
                                                {users.phone}
                                            </span>
                                        </div>
                                        <div className='Date p-top-10'>
                                            Dob :-
                                            <span>
                                                {users.birthDate}
                                            </span>
                                        </div>
                                        <div className='Address p-top-10'>
                                            Address :-
                                            <span>
            ...
            {/* <div className="photo col-4"></div>
                    <div className="username col-6">
                        ...
                        <div className='email p-top-10'>Email Id :-</div>
                    </div>
                    <div className="user-data col-12">
                        <div className="full-Name p-top-10">Full Name :-</div>
                        <div className='Phone-Number p-top-10'>Phone Number :-</div>
                        <div className='Date p-top-10'>Dob :-</div>
                        <div className='Address p-top-10'>Address :- </div>
                    </div> */}
